...
#   end
first_user = User.create(name: 'Sneezy', photo: 'https://drive.google.com/file/d/1XqjQFulatEIBwPbk_dQQ5HsdRapxHxDl/view?usp=sharing', bio: 'Achooo!')
second_user = User.create(name: 'Grumpy', photo: 'https://drive.google.com/file/d/1Wp1PnflGpKmeZBD0tBcq-yYMlEx_o_Fp/view?usp=sharing', bio: 'Grr. Argh.')
third_user = User.create(name: 'Doc', photo: 'hhttps://drive.google.com/file/d/1p0ATUoce5hwceUxYNboDApESI36QkUUK/view?usp=sharing', bio: 'An apple a day keeps this dwarf away.')
